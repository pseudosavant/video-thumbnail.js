...
export default getThumbnailDataURI;
export const clearCache = getThumbnailDataURI.clearCache;
export const cacheSize = getThumbnailDataURI.cacheSize;
export const getMemoryUsage = _getMemoryUsage;
export { cleanupObjectURLs };
export const clearCanvasPool = getThumbnailDataURI.clearCanvasPool;
